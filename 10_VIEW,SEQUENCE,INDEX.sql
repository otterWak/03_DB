...
-- DEPARTMENT 체이블을 복사한 DEPT_COPY2 생성 (테이블로 생성)
...
WHERE TEST_ID = 'TEST500000'; -- FETCHED - 0.013s

/* 인덱스 O */
-- TEST_NO가 5000000인 행 조회하기
SELECT * FROM TB_IDX_TEST
WHERE TEST_NO = 500000; -- FETCHED - 0.001s
-- 보통 10~30배 차이
