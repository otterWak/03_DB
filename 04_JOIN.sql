...
--    모든 행을 결과에 포함
--    ** ORACLE 구문 FULL OUTER JOIN 사용 못함 **
...
-- EMPLOYEE   JOB_CODE / DEPT_CODE   --> EMP_ID , EMP_NAME , SALARY
-- JOB        JOB_CODE               --> JOB_NAME
-- DEPARTMENT DEPT_ID  / LOCATION_ID --> DEPT_TITLE
-- LOCATION   LOCALL_CODE            --> LOCAL_NAME
SELECT * FROM EMPLOYEE;
SELECT * FROM JOB;
SELECT * FROM DEPARTMENT;
SELECT * FROM LOCATION;
