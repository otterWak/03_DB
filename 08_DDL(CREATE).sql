 ...
 * * USER_CPMSTRAINTS : 계정이 작성한 제약조건을 확인할 수 있는 딕셔너리 뷰
...
-- ** JDBC(JAVA, DB 연결해서 쓰는 것)에서 날짜를 입력 받았을 때 삽입하는 방법 **
...
-- ORA-01400: NULL을 ("KH_LHG"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]:
-- ORA-00001: 무결성 제약 조건(KH_LHG.USER_ID_U)에 위배됩니다
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: 
-- ORA-00001: 무결성 제약 조건(KH_LHG.USER_ID_NAME_U)에 위배됩니다
...
-- 테이블에 대한 식별자(사묭자번호, 학번..) 역할을 함

-- NOT NULL + UNIOQUE 제약조건의 의미 -> 중복되지 않는 값이 필수로 존재해야 함
...
-- 기본키 중복 오류
-- SQL Error [1] [23000]: 
-- ORA-00001: 무결성 제약 조건(KH_LHG.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES (NULL, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1111', 'yoo123@kh.or.kr');
-- 기본키 NULL 이므로 오류!
-- SQL Error [1400] [23000]: 
-- ORA-01400: NULL을 ("KH_LHG"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: 
-- ORA-00001: 무결성 제약 조건(KH_LHG.PK_USERNO_USERID)에 위배됩니다
-- USER_NO, USER_ID 둘 다 중복되었을 때만 제약조건 위배 에러 발생!

INSERT INTO USER_USED_PK2
VALUES (NULL, 'USER03', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1400] [23000]: 
-- ORA-01400: NULL을 ("KH_LHG"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2
VALUES (3, NULL, 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1400] [23000]: 
-- ORA-01400: NULL을 ("KH_LHG"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다
...
-- 자식테이블 (USER_GRADE 텡디블을 (참조하여) 사용할 테이블)
...
-- USER_GRADE (부모테이블/참조테이블)에 30이라는 GRADE_CODE가 존재하므로 가능
...
INSERT INTO USER_USED_FK
VALUES (5, 'USER05', 'PASS04', '윤봉길', '남자', '010-6666-7777', 'yoon123@kh.or.kr', 50);
-- SQL Error [2291] [23000]:
-- ORA-02291: 무결성 제약조건(KH_LHG.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- ORA-02292: 무결성 제약조건(KH_LHG.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
SELECT * FROM USER_GRADE2 ORDER BY GRADE_CODE;
...
-- ORA-02290: 체크 제약조건(KH_LHG.GENDER_CHECK)이 위배되었습니다
