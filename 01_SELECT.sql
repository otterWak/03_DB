 ...
 * 
 * 컬렴명 AS "별칭" : 별칭 띄어쓰기 O, 특수문자 O, 문자만 O
 * 
 * AS 생략 가능
 * */
...
-- ORDER BY 컬럼명 | 별칭 | 컬럼 순서 [ASC | DESC] [NULLS FIRST | LAST] : [오름 차순 | 내림 차순][NULL을 먼저 | 나중]
...
FROM EMPLOYEE
ORDER BY SALARY; -- ASC(오름차순)가 기본값 [ASC | DESC] ; 생략 가능
